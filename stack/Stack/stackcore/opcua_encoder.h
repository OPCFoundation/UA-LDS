...
{ \
    OpcUa_Int32 uFieldSize; \
    OpcUa_Int32 xValue; \
    xValue = (OpcUa_Int32)a_pValue->xName; \
    uStatus = a_pEncoder->WriteEnumerated(a_pEncoder, #xName, &xValue, &xType##_EnumeratedType, &uFieldSize); \
    OpcUa_GotoErrorIfBad(uStatus); \
    iSize += uFieldSize; \
}
...
{ \
    OpcUa_Int32 xValue; \
    xValue = (OpcUa_Int32)a_pValue->xName; \
    uStatus = a_pEncoder->WriteEnumerated(a_pEncoder, #xName, &xValue, &xType##_EnumeratedType, OpcUa_Null); \
    OpcUa_GotoErrorIfBad(uStatus); \
}
