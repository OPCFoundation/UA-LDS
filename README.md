 ...
 * Perl 
 * Windows:
    - OpenSSL v3.5.7 was used in development and testing: either built from source (https://www.openssl.org/source/) or as pre-built package, for example from https://slproweb.com/products/Win32OpenSSL.html.
...
| Open SSL Project | OpenSSL 3.5.7 | Apache License v2 https://www.openssl.org/source/license.html |
